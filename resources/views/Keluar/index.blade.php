                ...
                <table id="keluar" class="table table-bordered table-hover">
                  ...
                  @foreach($lu as $l)
                            <tr>
                                ...
                                <td >{{ $l->id_keluar}}</td>
                                <td >{{ $l->tgl_keluar}} </td>
                                <td >{{ $l->namalengkap_keluar}}</td>
                                <td >{{ $l->alasan}}</td>
                                <td >{{ $l->alamat_keluar}}</td>
                                <td >{{ $l->nohp_keluar}}</td>
                                <td >{{ $l->tempat_keluar}} {{$l->lahir_keluar}}</td>
                                <td >{{ $l->gereja_keluar}} </td>
                                <td >{{ $l->alamat}}</td>
                                <td >{{ $l->notelp_keluar}}</td>
                                <td >{{ $l->pekerjaan}}</td>
                                <td>
                                <a  href="" class='btn btn-success center-block' data-toggle="tooltip" title="edit" >Edit</a>
                                <a href="" class='btn btn-danger center-block' data-toggle="tooltip" title="">Hapus</a> 
                            </td>
                            </tr>                    
                        @endforeach
