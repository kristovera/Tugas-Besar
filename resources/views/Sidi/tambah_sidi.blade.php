    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="GET" action="/Sidi/tambah_sidi/simpan">
                <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="tglbap" class="form-control"  required />
        </div>
        ...
        <div class="form-group">
            <label>Hari</label>
            <input type="text" name="hari_sidi" class="form-control" required />
</div>
