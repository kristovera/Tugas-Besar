        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <table  class="table table-bordered  mati">
                  <thead>
                  <tr>
                        <th scope="col"> No </th>
                  ...
                  @foreach($ke as $k)
                            <tr>
                                ...
                                <td >{{ $k->jemaat->kode_jem}}</td>
                                <td >{{ $k->jemaat->namalengkap_jem}}</td>
                                <td >{{ $k->usia_mati}}</td>
                                <td >{{ $k->jemaat->alamat_jem}}</td>
                                <td >{{ $k->wafat}}</td>
                                <td>
                              
                                <a  href="/Kematian/edit/{{$k->id}}" class="fas fa-edit" data-toggle="tooltip" ></i></a> 
                                <a  href="/Kematian/delete/{{$k->id}}"  class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" ></i></a> 
                            </td>  
                            </tr>                                
                        @endforeach
