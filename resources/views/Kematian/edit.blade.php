      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <input type="text" class="form-control" id="namaLengkap" name="namaLengkap" value="{{ $k->namaLengkap }}" required="">
            </div> 

            <div class="form-group">
            <label for="name" class="col-sm-2 control-label">Usia</label>
            <input type="text" class="form-control" id="usia" name="usia"  maxlength="50" value="{{ $k->usia }}"required="">
            </div>
          

            <div class="form-group">
            <label for="name" class="col-sm-2 control-label">Alamat</label>
            <input type="text" class="form-control" id="alamat_kematian" name="alamat_kematian"value="{{ $k->alamat_kematian }}" maxlength="50" required="">
            </div>  

            <div class="form-group">
            <label for="name" class="col-sm-2 control-label">Wafat</label>
            <input type="date" class="form-control" id="wafat" name="wafat" maxlength="50" value="{{ $k->wafat }}" required="">
            </div> 
